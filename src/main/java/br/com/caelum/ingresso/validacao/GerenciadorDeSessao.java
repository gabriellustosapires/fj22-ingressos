...
public class GerenciadorDeSessao {
	...
	private boolean horarioIsValido(Sessao sessaoExistence, Sessao sessaoAtual){
		LocalDate hoje = LocalDate.now();
		
		LocalDateTime horarioSessao = sessaoExistence.getHorario().atDate(hoje);
		...
		if(ehAntes){
			...
			return horarioSessao
					.plus(sessaoExistence.getFilme().getDuracao())
